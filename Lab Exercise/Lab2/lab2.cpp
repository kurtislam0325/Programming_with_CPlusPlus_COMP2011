...
int main()
{
   ...
   for (int i = 0; i < numOfDigits; i++)
    {
        int substring, long_substring = inputNumber;
        long_substring %= static_cast<int>(pow(10,numOfDigits-i));
        for (int j = 0; j < numOfDigits-i; j++)
        {
            substring = long_substring;
            substring /= static_cast<int>(pow(10,j));
