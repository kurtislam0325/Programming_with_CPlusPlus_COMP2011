...
extern void stock_checking(const Fruit fruits[], int);

// Update stock info and print (name, total_count) pairs of each kind of fruit.
extern void stock_updating(Fruit fruits[], int, int);

// Calculate selling amount
extern float selling_amount_calculating(const Fruit fruits[], int);
